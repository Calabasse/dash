  ...
  "sessions": [
    {
      ...
      "fatigueAdvisory": {
        ...
        "session_id": null,
        "generated_at": "2026-09-10T06:30:23.210471",
        "fatigue_signal": {
        ...
        "deload_state": {
          "snapshot_date": "2026-09-09T00:00:00",
          "deload_flag": true,
      ...
      "exercises": [
        ...
        },
        {
          ...
          "recoveryOverlapWarning": "Day A (back/arms) also trains arms (assumed next-day spacing, not a logged session). This exercise's own recovery estimate (32h, volume stimulus, low fatigue) extends to 2026-09-09, past that. Advisory only -- no volume was changed.",
          "rpeAdjustmentAdvisory": "Would lower top RPE target 9 -> 8.75 based on a recent pattern of undershooting prescribed targets (signal -0.40). Advisory only -- the prescribed target is unchanged.",
          "decisionHistory": [
            {
              "date": "2026-08-19",
        ...
        },
        {
          ...
          "gate_status": "no_signal",
          "gate_reason": null,
          "recoveryOverlapWarning": "Day A (back/arms) also trains arms (assumed next-day spacing, not a logged session). This exercise's own recovery estimate (44h, stretch stimulus, low fatigue) extends to 2026-09-09, past that. Advisory only -- no volume was changed.",
          "rpeAdjustmentAdvisory": "Would lower top RPE target 9.5 -> 9.25 based on a recent pattern of undershooting prescribed targets (signal -0.40). Advisory only -- the prescribed target is unchanged.",
          "decisionHistory": [],
          "increaseCutoff": null,
          "reduceCutoff": null,
      ...
      "exercises": [
        ...
        },
        {
          ...
          "classificationReasons": [
            ...
            "Fatigue state for this occurrence: 'elevated'.",
            "Recovery-hours band width for this occurrence (volume stimulus, evaluated at a fixed moderate-fatigue baseline -- levels 4/5 own history recency alone): 36h.",
            "Upcoming primary exposure expected on day B (2026-09-06, 96h away).",
            "Level 3: resolved primary-owner day is B, not today's C; continuing to history/recovery evidence.",
            "Level 4 decided: exact-exercise exposure 24h ago against a 36h recovery window -> supplemental_volume."
          ]
        }
